...
export const events: Event[] = [
  {
    id: 'c1',
    category: 'concerts',
    title: 'Chibuzor Okoye: Lead & Inspire',
    venue: 'Grand Arena',
    date: 'Jun 13, Sat',
    time: '8:00 PM',
    priceFrom: 59,
    priceTo: 199,
    imageUrl: IMAGES.chibuzorLead,
    top: true,
  },
  {
    id: 'c2',
    category: 'concerts',
    title: 'Chibuzor Okoye: Live Keynote',
    venue: 'City Hall Auditorium',
    date: 'Jun 15, Mon',
    time: '7:30 PM',
    priceFrom: 45,
    priceTo: 120,
    imageUrl: IMAGES.chibuzorKeynote,
  },
  {
    id: 'c3',
    category: 'concerts',
    title: 'Chibuzor Okoye: Impact Night',
    venue: 'Brooklyn Steel',
    date: 'Jun 20, Sat',
    time: '9:00 PM',
    priceFrom: 75,
    priceTo: 250,
    imageUrl: IMAGES.chibuzorImpact,
  },
  {
    id: 'c4',
    category: 'concerts',
